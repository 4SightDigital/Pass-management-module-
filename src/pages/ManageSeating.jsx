      ...
      <div className="max-w-7xl mx-auto">
        ...
        <header className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600 max-w-3xl">
                Create and organize hierarchical seating categories for your venues. 
                Follow the step-by-step process to allocate seats efficiently.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-4 mt-6">
            <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-lg shadow-sm border border-gray-200">
              ...
              <span className="text-sm font-medium text-gray-700">Select Venue</span>
            </div>
            <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-lg shadow-sm border border-gray-200">
              <div className="w-6 h-6 rounded-full bg-blue-100 text-blue-600 font-semibold text-sm flex items-center justify-center">
                2
            ...
            <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-lg shadow-sm border border-gray-200">
              ...
              <span className="text-sm font-medium text-gray-700">Validate & Save</span>
            </div>
          </div>
        </header>
        ...
        {venues.length === 0 ? (
          ...
          <div className="bg-white rounded-2xl shadow-xl p-10 text-center max-w-2xl mx-auto border border-gray-200">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-3">No Venues Added</h3>
            <p className="text-gray-500 text-lg mb-8 max-w-md mx-auto">
              Start by adding venues to create your seating layouts. Each venue can have multiple categories and subcategories.
            </p>
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-5">
                      ...
                      <div className="relative">
                        ...
                        <div className="absolute -top-1 -right-1 w-6 h-6 bg-white border-2 border-blue-500 rounded-full flex items-center justify-center">
                          <span className="text-xs font-bold text-blue-600">{hierarchy.length}</span>
                        </div>
                      </div>
                      ...
                      <div className="text-left">
                        <div className="flex items-center gap-3 mb-2">
                          <h2 className="font-bold text-gray-900 text-xl">{venue.name}</h2>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div className="w-24 h-2 bg-gray-200 rounded-full overflow-hidden">
                              <div 
                                ...
                                style={{ width: `${(usedSeats / venue.total_capacity) * 100}%` }}
                              />
                            </div>
                          </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      {/* Expand Icon */}
                      <span className={`transform transition-transform duration-300 text-gray-400 group-hover:text-gray-600 ${
                        isOpen ? "rotate-180" : ""
                      }`}>
                    ...
                    <div className="p-6 border-t border-gray-100 bg-gradient-to-b from-white to-gray-50/50">
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              <h4 className={`font-semibold ${
                                ...
                                {venueSaveStatus.type === "success" ? "Success!" : "Save Failed"}
                              </h4>
                              <p className={`text-sm ${
                                venueSaveStatus.type === "success"
                                  ? "text-emerald-700"
                      ...
                      <div className="mb-8 p-5 bg-gradient-to-r from-blue-50 to-white rounded-xl border border-blue-100">
                        <div className="flex items-center justify-between mb-5">
                          <div>
                            <div className="flex items-center gap-3 mb-2">
                              ...
                              <h3 className="text-lg font-bold text-gray-900">Add Main Category</h3>
                            </div>
                            <p className="text-sm text-gray-600 ml-11">
                              Create primary seating sections (e.g., VIP, General Admission, Balcony). 
                        ...
                        <div className="ml-11 mb-4">
                          <div className="flex items-center justify-between text-sm text-gray-600 mb-2">
                            <span>Venue capacity: <strong>{venue.total_capacity}</strong> seats</span>
                            <span>Available: <strong className="text-emerald-600">{venueRemainingSeats}</strong> seats</span>
                          </div>
                          <div className="w-full h-3 bg-gray-200 rounded-full overflow-hidden">
                            <div 
                              className="h-full bg-gradient-to-r from-blue-400 to-blue-600"
                              style={{ width: `${((venue.total_capacity - venueRemainingSeats) / venue.total_capacity) * 100}%` }}
                            />
                          </div>
                        </div>
                        ...
                        <div className="ml-11">
                          <AddCategory
                            ...
                            onAdd={(cat) => {
                              ...
                              const remainingSeats = venue.total_capacity - usedSeats;

                              if (cat.seats > remainingSeats) {
                                alert(`Cannot add category: Only ${remainingSeats} seats remaining in venue`);
                                return;
                              }

                              if (!isCategoryNameUnique(venue.id, cat.name)) {
                                alert(`Category name "${cat.name}" is already used. Please choose a different name.`);
                                return;
                              }
                      ...
                      {loadingHierarchies[venue.id] ? (
                        ...
                        <div className="py-12 text-center border-2 border-dashed border-gray-300 rounded-xl bg-white/50 mb-8">
                          ...
                          <h4 className="text-lg font-semibold text-gray-700 mb-2">No Categories Yet</h4>
                          <p className="text-gray-500 max-w-md mx-auto mb-6">
                            Start by adding your first main category above. Categories help organize your seating into logical sections.
                          </p>
                        ...
                        <div className="space-y-6 mb-8">
                          <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center gap-3">
                              ...
                              <h3 className="text-lg font-bold text-gray-900">Categories & Subcategories</h3>
                            </div>
                            <div className="flex items-center gap-3">
                              ...
                              >
                                      ...
                                      <div className="relative">
                                        <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                                          ...
                                          <span className={`font-bold text-lg ${
                                            seatError || nameError ? "text-red-700" : "text-blue-700"
                                          }`}>
                                            {catIndex + 1}
                                          </span>
                                        </div>
                                        {cat.children.length > 0 && (
                                          <div className="absolute -top-2 -right-2 w-6 h-6 bg-white border border-gray-300 rounded-full flex items-center justify-center shadow-sm">
                                            <span className="text-xs font-bold text-gray-700">{cat.children.length}</span>
                                          </div>
                                        )}
                                      </div>
                                      ...
                                      <div className="flex-1">
                                        ...
                                        <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600 mb-4">
                                          <span className="flex items-center gap-1">
                                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5 2.0" />
                                            </svg>
                                          ...
                                          <span className={`flex items-center gap-1 font-medium ${
                                            availableSeats > 0 ? "text-emerald-600" : "text-amber-600"
                                          }`}>
                                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div className="mb-4">
                                          <div className="flex justify-between text-sm text-gray-600 mb-2">
                                            <span className="font-medium">Seat Allocation</span>
                                            <span>{usedSeats} of {cat.seats} seats used</span>
                                          </div>
                                          <div className="w-full h-3 bg-gray-200 rounded-full overflow-hidden">
                                            <div 
                                              ...
                                              style={{ width: `${Math.min((usedSeats / cat.seats) * 100, 100)}%` }}
                                            />
                                          </div>
                                          <div className="flex justify-between text-xs text-gray-500 mt-2">
                                            <span>0</span>
                                            <span>{Math.round(cat.seats / 2)}</span>
                                            <span>{cat.seats}</span>
                                          </div>
                                        </div>
                                            ...
                                            <div className="flex items-center gap-3">
                                              ...
                                              <div>
                                                ...
                                                <p className="text-xs text-red-600">
                                                  {seatError ? "Reduce subcategory seats or increase category seats" : "Use a unique name for this category"}
                                                </p>
                                              </div>
                                            </div>
                                          </div>
                                ...
                                <div className="mt-5 pt-5 border-t border-gray-100">
                                  <div className="flex items-center justify-between mb-5">
                                    <div className="flex items-center gap-3">
                                      ...
                                      <div>
                                        <h5 className="font-semibold text-gray-900">Add Subcategory</h5>
                                  ...
                                  {availableSeats <= 0 ? (
                                    <div className="p-4 bg-gradient-to-r from-amber-50 to-amber-100 border border-amber-200 rounded-lg">
                                      <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                          <p className="font-semibold text-amber-800">Category at Full Capacity</p>
                                          <p className="text-sm text-amber-700 mt-1">
                                            All {cat.seats} seats have been allocated to subcategories.
                                          </p>
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <AddSubCategory
                                      ...
                                      onAdd={(sub) => {
                                        if (sub.seats > availableSeats) {
                                          alert(`Cannot add: Only ${availableSeats} seats available in this category`);
                                          return;
                                        }

                                        if (!isSubcategoryNameUnique(venue.id, catIndex, sub.name)) {
                                          alert(`Name "${sub.name}" already exists in this category. Please choose a different name.`);
                                          return;
                                        }
                                ...
                                {expanded && cat.children.length > 0 && (
                                  <div className="mt-6 pt-6 border-t border-gray-200">
                                    <div className="flex items-center justify-between mb-5">
                                      <div className="flex items-center gap-3">
                                        <h5 className="font-bold text-gray-900 text-lg">Subcategories</h5>
                                        <span className="px-2.5 py-1 bg-gray-100 text-gray-700 text-xs font-semibold rounded-full">
                                          {cat.children.length} items
                                        </span>
                                      </div>
                                      <div className="text-sm text-gray-500">
                                        Total allocated: <strong className="text-gray-700">{usedSeats}</strong> seats
                                      </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                      {cat.children.map((sub, subIndex) => {
                                        ...
                                        const seatError = validationErrors[`${errorId}-seats`];
                                        const nameError = validationErrors[`${errorId}-name`];
                                        const hasError = seatError || nameError;
                                        const isEditing = editingSub?.venueId === venue.id &&
                                            ...
                                            <div className="flex justify-between items-start mb-3">
                                              <div className="flex items-center gap-2">
                                                <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${
                                                  hasError ? "bg-red-100" : "bg-gradient-to-r from-gray-50 to-gray-100"
                                                }`}>
                                                ...
                                                <div>
                                                  {isEditing ? (
                                                    ...
                                                    <>
                                                      <h6 className="font-semibold text-gray-900">{sub.name}</h6>
                                                      {nameError && (
                                              ...
                                              <button
                                                onClick={() => {
                                                  if (window.confirm(`Delete "${sub.name}"?`)) {
                                                    deleteSubCategory(venue.id, catIndex, subIndex);
                                                  }
                                                }}
                                              ...
                                              <div>
                                                ...
                                                {isEditing ? (
                                                  <input
                                                    type="number"
                                                    min="1"
                                                    max={availableSeats + sub.seats}
                                                    value={editingSub.seats}
                                                    onChange={(e) => setEditingSub({...editingSub, seats: Math.max(1, Number(e.target.value) || 0)})}
                                                  ...
                                                  <div className="flex items-baseline gap-1">
                                                    <span className="text-2xl font-bold text-gray-900">{sub.seats}</span>
                                              ...
                                              <div className="flex gap-2">
                                                {isEditing ? (
                                                  <>
                                                    <button
                                                      onClick={() => {
                                                        editSubCategory(venue.id, catIndex, subIndex, {
                                                          name: editingSub.name,
                                                          seats: editingSub.seats,
                                                        });
                                                        setEditingSub(null);
                                                      }}
                                              ...
                                              <div className="mt-3 pt-3 border-t border-gray-100">
                                                <div className="flex items-start gap-2">
                                                  ...
                                                  <span className="text-xs text-red-600 font-medium">
                                                    {seatError?.message || nameError?.message}
                                                  </span>
                                                </div>
                                              </div>
                                            )}
                      ...
                      <div className="mt-8 pt-6 border-t border-gray-200">
                        <div className={`p-5 rounded-xl mb-6 ${
                          ...
                          <div className="flex items-start gap-4">
                            ...
                            <div>
                              ...
                              <p className={`text-sm ${
                                hasErrors ? "text-red-700" : "text-emerald-700"
                              }`}>
                                {hasErrors
                              ...
                              {!hasErrors && (
                                <p className="text-xs text-emerald-600 mt-2">
                                  Total seats allocated: {venue.total_capacity - venueRemainingSeats} of {venue.total_capacity}
                                </p>
                              )}
                            </div>
                          </div>
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                          <div>
                            <h5 className="font-semibold text-gray-900 mb-1">Save Seating Layout</h5>
                            <p className="text-sm text-gray-600">
                              This will update the seating configuration for <strong>{venue.name}</strong>
                            </p>
                            <p className="text-xs text-gray-500 mt-1">
                              Changes will be reflected immediately in event creation
                            </p>
                          </div>
                          <button
